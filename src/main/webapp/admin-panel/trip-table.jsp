		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							<h3 class="box-title">Trip Table</h3>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										for (Trip t : trips) {
											...
											out.print("<td>");
											out.print("<a href='../DeleteTripServlet?id=" + id + "'" + "class='btn btn-danger' style='color:white'>Delete</a>");
											out.print("&nbsp&nbsp");
											out.print("<a href='edit-trip.jsp?id=" + id + "'" + "class='btn btn-success' style='color:white'>Edit</a>");
											out.print("</td>");
											out.print("</tr>");
										}
										%>
							...
							<a href="add-trip.jsp" class="btn btn-primary">Add New Trip</a>
						</div>
					</div>
				</div>
				<!-- ============================================================== -->
