...
String query = new String("Select * from trip where id = " + id);
Trip trip = null;
try {
	...
	trip = new Trip(id, name, destination, price, photo);
		} while (rs.next());
		stmt.close();
		dbConnect.close();
	}
				...
				<div class="row">
					<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
						<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
							<div class="row">
								<div class="col-12">
									<h2 class="tm-block-title d-inline-block">Edit Trip</h2>
								</div>
							</div>
							<div class="row tm-edit-product-row">
								<div class="col-xl-6 col-lg-6 col-md-12">
									<%
									out.print(
											"<form action='../UpdateTripServlet?id=" + trip.getID() + "'" + "method='post' class='tm-edit-product-form'>");
									%>
									<div class="form-group mb-3">
										<label for="name">Trip Name</label>
										<%
										out.print("<input id='name' name='name' type='text' value = '" + trip.getName() + "'"
									...
									<div class="form-group mb-3">
										...
										<%
										out.print("<input id='destination' name='destination' type='text' value = '" + trip.getDestination() + "'"
												+ "class= 'form-control validate'>");
										%>
									</div>
									<div class="form-group mb-3">
										...
										<%
										out.print("<input id='price' name='price' type='number' value = '" + trip.getPrice() + "'"
												+ "class= 'form-control validate'>");
										%>
									</div>
								</div>
