...
<%
String query = new String("Select * from travel");
...
try {
	...
	Travel travel = new Travel(id, name, destination, price, photo);
	travels.add(travel);
		} while (rs.next());
		stmt.close();
		dbConnect.close();
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							<h3 class="box-title">Travel Table</h3>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										for (Travel t : travels) {
											...
											out.print("<td>");
											out.print("<a href='../DeleteTravelServlet?id=" + id + "'" + "class='btn btn-danger' style='color:white'>Delete</a>");
											out.print("&nbsp&nbsp");
											out.print("<a href='edit-travel.jsp?id=" + id + "'" + "class='btn btn-success' style='color:white'>Edit</a>");
											out.print("</td>");
											out.print("</tr>");
										}
										%>
							...
							<a href="add-travel.jsp" class="btn btn-primary">Add New Travel</a>
						</div>
					</div>
				</div>
				<!-- ============================================================== -->
