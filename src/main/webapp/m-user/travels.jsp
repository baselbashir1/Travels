						...
						<table class="table table-hover tm-table-small tm-product-table">
							...
							<tbody>
								...
								for (Travel t : travels) {
									...
									out.print("<td>");
									out.print("<a href='../DeleteTravelServlet?id=" + id + "'" + "class='tm-product-delete-link'>");
									out.print("<i class='far fa-trash-alt tm-product-delete-icon'></i>");
									out.print("</a>");
									out.print("&nbsp&nbsp");
									out.print("<a href='edit-travel.jsp?id=" + id + "'" + "class='tm-product-edit-link'>");
